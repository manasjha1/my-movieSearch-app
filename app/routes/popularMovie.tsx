...
export default function PopularMovie() {
    ...
    return (
        <div>
            <Headers movies={null} filterMovies={function (): void { }} />
            <div className="mx-auto flex max-w-7xl flex-col gap-6">
                        ...
                        <div className="relative flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                            <div className="max-w-2xl">
                                ...
                                <p className="mt-3 max-w-xl text-sm leading-7 text-white/70 sm:text-base">
                                    Discover the most talked-about releases that are keeping audiences engaged right now.
                                </p>
                            </div>
                ...
                <div className="flex items-baseline justify-between px-8 mb-6">
                    <span className="w-full">
                        Showing page: {page} of total {popularMovie.total_pages}
                    </span>
